...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            db.execSQL(GoogleMarketApiDataSource.CREATE_TABLE);
            db.execSQL(OrderDataSource.CREATE_TABLE);
            db.execSQL(PlantDataSource.CREATE_TABLE);
            db.execSQL(ProductSuggestionDataSource.CREATE_TABLE);
            db.execSQL(ReminderDataSource.CREATE_TABLE);
            db.execSQL(ReminderTypeDataSource.CREATE_TABLE);
            db.execSQL(SoilDataApiDataSource.CREATE_TABLE);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        /*
          ...
          */
            ...
            db.execSQL("DROP TABLE IF EXISTS " + GoogleMarketApiDataSource.TABLE_NAME);
            db.execSQL("DROP TABLE IF EXISTS " + OrderDataSource.TABLE_NAME);
            db.execSQL("DROP TABLE IF EXISTS " + PlantDataSource.TABLE_NAME);
            db.execSQL("DROP TABLE IF EXISTS " + ProductSuggestionDataSource.TABLE_NAME);
            db.execSQL("DROP TABLE IF EXISTS " + ReminderDataSource.TABLE_NAME);
            db.execSQL("DROP TABLE IF EXISTS " + ReminderTypeDataSource.TABLE_NAME);
            db.execSQL("DROP TABLE IF EXISTS " + SoilDataApiDataSource.TABLE_NAME);
